...
1. __Vulnerable ACL Issues: Client Callable Script Include (CCSI) Attribute__
```
...
![ACL Issues: Insecure ACL - record](./images/insecure-acl-record.jpg "Insecure ACL - record")
